package com.tamer.raed.doctorappointment.doctor.ui.activities.signUpActivities;
...
public class SpecializationActivity extends AppCompatActivity {
    ...
    private boolean checkFields() {
        if (specializationSpinner.getSelectedItemPosition() > 0) {
            ...
            Toast.makeText(this, getText(R.string.specialization_error), Toast.LENGTH_LONG).show();
            return false;
        }
    }
    ...
    private void signUpFirebase() {
        ...
        db.collection("Doctors").document(userId).set(map, SetOptions.merge()).addOnCompleteListener(task1 -> {
            if (task1.isSuccessful()) {
                ...
                Toast.makeText(SpecializationActivity.this, getString(R.string.error_sign_up), Toast.LENGTH_SHORT).show();
            }
        });
    }
}